...
class _SchemsDetailsState extends State<SchemsDetails> {
 ...
 ApiServices.getSchemsDetails(widget.scheme);
                  ...
                  builder: (ctx, snapshot) {
                    if (snapshot.hasData) {
                      if (snapshot.data!.result != null) {
                        ...
                        final brochureimage = data.schemeDetails!.first.brochure;
            
                        final schemeimages = data.schemeDetails!.first.schemeImages;
                        final paragraph = data.schemeDetails!.first.schemeDescription;
            
                        final output = '$paragraph'.replaceAll(RegExp('<p>'), '');
                        final description = output.replaceAll(RegExp('</p>'), '');
            
                        final video = data.schemeDetails!.first.video.toString();
                        final substrings = video.split("<p><a href=");
                             ...
                             children: [
                              ...
                              showDialog(
                                                    ...
                                                    child: schemeimage == 'null'
                                                        ? Text("")
                                                        : Image.network(
                                                            'https://dmlux.in/project/public/files/${data.schemeDetails!.first.schemeImg}'),
                                                  ))
                                            ],
                                          ))
                                        ],
                                ...
                                data.schemeDetails!.first.schemeImages
                                            .toString() ==
                                        ""
                                    ? SizedBox()
                                    : const Row(
                                                        ...
                                                        child: InkWell(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      ElevatedButton(
                                                                        ...
                                                                        onPressed:
                                                                            () {
                                                                          download(
                                                                              "https://dmlux.in/project/public/scheme_images/${item.toString()}");
                                                          ...
                                                          child: schemeimage ==
                                                              ...
                                                              : Padding(
                                                                  ...
                                                                  child: Image
                                                                      .network(
                                                                          'https://dmlux.in/project/public/scheme_images/${item}'),
                                                                ),
                                                        )),
                                                ],
                                              ),
                                                                ...
                                                                children: [
                                                                  ...
                                                                  ElevatedButton(
                                                                    ...
                                                                    onPressed:
                                                                        () {
                                                                      download(
                                                                          "https://dmlux.in/project/public/brochure/${data.schemeDetails!.first.brochure.toString()}");
                                                                      Navigator.of(
                                                                              context)
                                                                          .pop();
                                                                    },
                                                                        ...
                                                                        content:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            ElevatedButton(
                                                                              ...
                                                                              onPressed:
                                                                                  () {
                                                                                download("https://dmlux.in/project/public/ppt/${data.schemeDetails!.first.ppt.toString()}");
                                                                                Navigator.of(context).pop();
                                                                              },
                                                                              child:
                                                                                  Text('Download'),
                                                                          ...
                                                                          content:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              ElevatedButton(
                                                                                  style: ElevatedButton.styleFrom(primary:Color(0xff03467d),),
                                                                                onPressed: () {
                                                                                  download("https://dmlux.in/project/public/jda_map/${data.schemeDetails!.first.jdaMap.toString()}");
                                                                                  Navigator.of(context).pop();
                                                                                },
                                                                                child: Text('Download'),
                                                                              ),
                                                                      ...
                                                                      : InkWell(
                                                                                ...
                                                                                return AlertDialog(
                                                                                  ...
                                                                                  content:
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      ElevatedButton(
                                                                                        onPressed: () {
                                                                                          download("https://dmlux.in/project/public/pra/${data.schemeDetails!.first.pra.toString()}");
                                                                                          Navigator.of(context).pop();
                                                                                        },
                                                                                        child: Text('Download'),
                                                                                      ),
                                                                          ...
                                                                          child: data
                                                                              ...
                                                                              : data.schemeDetails!.first.pra.toString().contains('.jpg') ||
                                                                                      data.schemeDetails!.first.pra.toString().contains('.png') ||
                                                                                      data.schemeDetails!.first.pra.toString().contains('.JPEG') ||
                                                                                      data.schemeDetails!.first.pra.toString().contains('.GIF')
                                                                                  ? Icon(Icons.image)

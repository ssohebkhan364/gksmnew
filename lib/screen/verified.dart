        ...
        body:
         ...
         FutureBuilder(
            ...
            builder: (ctx, snapshot) {
              if (snapshot.hasData) {
                if (snapshot.data!.result!.proofvdata!.length > 0) {
                  return 
                    ...
                    SmartRefresher(
                            ...
                            child: 
                  ListView.builder(
                      itemCount: snapshot.data!.result!.proofvdata!.length,
                      itemBuilder: (BuildContext context, int index) {

                                                
  DateTime date_time = DateTime.parse((snapshot
                                                  .data!
                                                  .result!
                                                  .proofvdata![index]
                                                      ...
                                                      SizedBox(
                                                        ...
                                                        child: snapshot
                                                            ...
                                                            : InkWell(
                                                                        ...
                                                                        content:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            ElevatedButton(
                                                                              ...
                                                                              onPressed: () {
                                                                                download('${UrlHelper.imaeurl}customer/payment/${snapshot.data!.result!.proofvdata![index].proofImage.toString()}');
                                                                ...
                                                                child: Image
                                                                    .network(
                                                                        '${UrlHelper.imaeurl}customer/payment/${snapshot.data!.result!.proofvdata![index].proofImage.toString()}'),
                                                              ),
                                                      ),
                                                    ],
                                                  ),
